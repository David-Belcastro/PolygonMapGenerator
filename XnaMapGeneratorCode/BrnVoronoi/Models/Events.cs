...
{
    public abstract class VEvent : IComparable
    {
    ...
    public class VDataEvent : VEvent
    {
    ...
    public class VCircleEvent : VEvent
    {
        ...
        public override double Y
        {
            get
            {
                return Math.Round(Center[1] + Methods.Distance(NodeN.DataPoint[0], NodeN.DataPoint[1], Center[0], Center[1]), 10);
            }
        }
