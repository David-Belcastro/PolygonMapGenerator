...
namespace CubesFortune.CubesFortune.Tests
{
    ...
    public class EventQueueTests
    {
        ...
        {
            var mockedQueue = new EventQueue { NodeList = new List<IVoronoiPoint> { new SiteEvent(new VoronoiPoint(1, 1)) } };
            mockedQueue.AddNode(new SiteEvent(new VoronoiPoint(1, 1)));
        ...
        public void RemoveSmallestTest_YTest_Listof3TurnsIntoListOf2()
        {
            ...
            mockedQueue.AddNode(new SiteEvent(new VoronoiPoint(1, 2)));
