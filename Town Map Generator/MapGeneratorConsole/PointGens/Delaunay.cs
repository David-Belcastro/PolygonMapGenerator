    ...
    public class DelaunayTriangulation2d
    {
        ...
        public List<Triangle> Triangulate(List<Point> triangulationPoints)
        {
            ...
            for ( int i = 0; i < triangulationPoints.Count; i++ )
            {
                ...
                List<DTEdge> EdgeBuffer = new List<DTEdge>();
                ...
                for ( int j = triangles.Count - 1; j >= 0; j-- )
                {
                    ...
                    {
                        EdgeBuffer.Add(new DTEdge(t.Vertex1, t.Vertex2));
                        EdgeBuffer.Add(new DTEdge(t.Vertex2, t.Vertex3));
                        EdgeBuffer.Add(new DTEdge(t.Vertex3, t.Vertex1));
